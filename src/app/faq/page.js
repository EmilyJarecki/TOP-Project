...
export default function Faq() {
    ...
    return (
        ...
        <br />
        <center>
            <p className="flex relative justify-between items-center pt-6 pb-8 w-full text-left-[13px]  ease-out duration-500 font-rubik font-bold text-hych-subheading-blue leading-none tracking-tight">What is the goal of MakeMyTestCount?</p>
        </center>
        <br />
        <center>
            <p className="pr-[1.875rem] pb-[1.25rem] text-[13px]  ease-out duration-500 font-rubik font-bold text-hych-subheading-blue leading-none tracking-tight">
