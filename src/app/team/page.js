            ...
            {/* <center> */}
                <div class="grid grid-cols-6 gap-4 mb-5 w-full px-6 sm:grid-cols-2 md:grid-cols-4 pb-8">
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6 flex flex-col items-center">
                            <h2 class="font-bold mb-2 text-2xl text-black-800 text-center">Ceina Ellison
                            </h2>
                            <p class="text-black-700 mb-2 text-center">Product Manager <br /> Software Engineer</p>
                    ...
                    <div class="p-6 flex flex-col items-center">
                        <h2 class="font-bold mb-2 text-2xl text-black-800 text-center">Ralph Rezza
                        </h2>
                        <p class="text-black-700 mb-2 text-center">Product Manager <br /> UX/UI Lead</p>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6 flex flex-col items-center">
                            <h2 class="font-bold mb-2 text-2xl text-black-800 text-center">Josh Bellon
                            </h2>
                            <p class="text-black-700 mb-2 text-center">Lead Software Engineer</p>
                    ...
                    <div class="p-6 flex flex-col items-center">
                        <h2 class="font-bold mb-2 text-2xl text-black-800 text-center">Bekzod Tolipov
                        </h2>
                        <p class="text-black-700 mb-2 text-center">Data Lead</p>
                ...
                <div class="grid grid-cols-6 gap-x-4 gap-y-12 mb-5 w-full px-6 sm:grid-cols-2 md:grid-cols-4">
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6 flex flex-col items-center">
                            <h2 class="font-bold mb-2 text-2xl text-black-800 text-center">Abdiresac Sheikdon
                            </h2>
                            <p class="text-black-700 mb-2 text-center">Software Engineer</p>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6 flex flex-col items-center">
                            <h2 class="font-bold mb-2 text-2xl text-black-800 text-center">Alaysia Veal
                            </h2>
                            <p class="text-black-700 mb-2 text-center">Software Engineer</p>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6 flex flex-col items-center">
                            <h2 class="font-bold mb-2 text-2xl text-black-800 text-center">Cindy Amaya
                            </h2>
                            <p class="text-black-700 mb-2 text-center">Software Engineer</p>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6 flex flex-col items-center">
                            <h2 class="font-bold mb-2 text-2xl text-black-800 text-center">Emily Jarecki
                            </h2>
                            <p class="text-black-700 mb-2 text-center">Software Engineer</p>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6 flex flex-col items-center">
                            <h2 class="font-bold mb-2 text-2xl text-black-800 text-center">Mary Lueder
                            </h2>
                            <p class="text-black-700 mb-2 text-center">Software Engineer</p>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6 flex flex-col items-center">
                            <h2 class="font-bold mb-2 text-2xl text-black-800 text-center">Youssef Shabo
                            </h2>
                            <p class="text-black-700 mb-2 text-center">Software Engineer</p>
