...
export default function Team() {
    ...
    return (
        <>
            ...
            <br />
            <center>
                <div class="grid grid-cols-6 gap-4 mb-5 w-full px-6 sm:grid-cols-2">
                    <div class="bg-blue rounded-lg shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <a target="_blank" href="https://docs.google.com/document/d/1KTQGdWdv8DpUy7wVG4P_t8jZrh6xPG243oVZavHpGow/edit?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <a target="_blank" href="https://docs.google.com/document/d/18GaipFPA3G17Y2obIWgcQrbkCW345BrO/edit?usp=sharing&ouid=101137335363524302635&rtpof=true&sd=true" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <a target="_blank" href="https://drive.google.com/file/d/13iQZtzUi-qSNhMDe1AnoQs6_sBTZ3Q5-/view?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-black-700 mb-2">Software Engineer</p>
                            <a target="_blank" href="https://docs.google.com/document/d/1IA90wWc4-yGIssioHjHuXc0Db-rvgfekegRmOinoCBI/edit?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-black-700 mb-2">Software Engineer</p>
                            <a target="_blank" href="https://docs.google.com/document/d/1e82JLykIIkQ0YoqBquWLN1C6DZjU0-ekReQCKt5AHrk/edit?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-black-700 mb-2">Software Engineer</p>
                            <a target="_blank" href="https://drive.google.com/file/d/1KxtmLLNcm7zXaGGFVc7JEVCTX3P4wHO_/view?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-black-700 mb-2">Software Engineer</p>
                            <a target="_blank" href="https://docs.google.com/document/d/1YQ4qWm2krafjRJQzGg1jzOeDzky2kYIeY3BrZrN3ARg/edit?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-black-700 mb-2">Software Engineer</p>
                            <a target="_blank" href="https://docs.google.com/document/d/1KUO9Hun26VBhlIoHJRVfGxnwL-cZemRYki9soIat3Wk/edit" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
            ...
            <div class="grid grid-cols-6 gap-4 mb-8 w-full sm:grid-cols-2 px-6">
                <div class="bg-white rounded-lg shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <a target="_blank" href="https://docs.google.com/document/d/1X436Dt5QzrBrGz-F089tNscOWeg_gRLqJd_xC1keF1o/edit?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                ...
                <div class="bg-white rounded-lg shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <a target="_blank" href="https://drive.google.com/file/d/1NBqNgQgeqAyQBnqUU3xwgf4JBxMz_9FL/view?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                ...
                <div class="bg-white rounded-lg shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-black-700 mb-2">UX/UI Researcher / Designer</p>
                        <a target="_blank" href="https://docs.google.com/document/d/1T-W8me7SJwA0jL4hSEB5L3bYtxBGfW41JhvGSh-qCeQ/edit?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
            ...
            <div class="grid grid-cols-6 gap-4 mb-8 w-full sm:grid-cols-2 px-6">
                <div class="bg-white rounded-lg shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <a target="_blank" href="https://drive.google.com/file/d/18u7p7ZwLKMpjy5mpjNmghMz3Wmce9gGk/view?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                ...
                <div class="bg-white rounded-lg shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <a target="_blank" href="https://drive.google.com/file/d/1790tQ8l6JGqhyEcbICJpgNvOjDB__jnp/view?usp=sharing" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
                ...
                <div class="bg-white rounded-lg shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <a target="_blank" href="https://docs.google.com/document/d/1OY0FT6H_i5l6FqBadGd59z3RArd1eOE3p9osEJYZ29w/edit?usp=drivesdk" class="text-black-600 hover:text-black-500 underline text-sm">Download Resume</a>
            ...
            <h1 className="thanks text-center font-black" >Thank You</h1>
            <h2 className="message px-6 text-center font-semibold">A special thank you to The Opportunity Project 2023, General Assembly, and the US Census Bureau for creating this chance for us to showcase our skills.</h2>
            <Footer />
        </>
