  ...
  return (
    <div className="relative flex flex-col min-h-screen ">
      <div className="bg-slate-700 absolute bottom-0 text-white px-14 py-4">
        <div className="text-[10px] mb-4 text-center">
        ...
        <div className="text-[6px] font-bold">
          <p>The MakeMyTestCount.org site does not provide professional medical
          advice. Consult a qualified health care provider for answers to your
          medical questions.
          </p>
          <p>
            The information provided on this website is only
        ...
        <SocialMedia />
        <p className="text-[6px] text-center">@ 2023 CareEvolution, LLC. | <span className="hover:underline">Privacy Policy</span></p>
      </div>
    </div>
  );
};
